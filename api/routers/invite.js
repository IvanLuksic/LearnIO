...
module.exports=function(main_ruter)
{
    ...
    invite.get('/invite/to/class/:class_id/:maxJoins',authenticate_admin_or_teacher,invite_controler.getInviteLink);//admin ili teacher odabere razred za kojeg zeli generirat JEDINSTVENI link preko kojeg ce se ucenik upisati u razred
