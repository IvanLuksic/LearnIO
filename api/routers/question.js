...
module.exports=function (main_ruter){
    ...
    question.post('/question/add',ShemaValidator.validate('addQuestion'),authenticate_admin_or_teacher,upload,question_controler.addQuestions);// multer.single('ime propertya/fileda u request bodyu)    multer.single middleware konstruira req.file objekt
