...
module.exports=function (main_ruter){
    ...
    topic.get('/student/topics/:class_id/:subject_id/:course_id',authenticate_student,topic_controler.getTopics);//za studenta svi topici
    topic.get('/admin/topics',authenticate_admin,topic_controler.getAdminTopics);//za admina svi topici
    topic.get('/admin/topics/edit/:topic_id',authenticate_admin, topic_controler.getAdminTopicsEdit);//glavna matrica di se uređuje topic
