...
module.exports=function (main_ruter){
    ...
    topic.get('/student/topics/:class_id/:subject_id/:course_id',authenticate_student,topic_controler.getTopics);//za studenta->svi topici iz kursa u koji uđe-> prethodno su odabrali razred i predmet
    ...
    topic.post('/admin/add/topic',ShemaValidator.validate('addTopic') ,authenticate_admin_or_teacher,topic_controler.addTopics);
}
