...
function StudentSubject(props){
    ...
    if(Number(props.match.params.class_id && Number(props.match.params.subject_id))){changeToNoError();};//dispatch(subjectSelected(props.match.params.id,"Topic"))
    if((!Number(props.match.params.class_id))||(!Number(props.match.params.subject_id))){changeToError()};
