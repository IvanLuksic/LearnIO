...
function DisplayField(props){
    ...
    return (
            ...
            <Grid item> 
                <Paper onClick={(event)=>{if(status==='UNLOCKED'){props.changeSelected(event,props.ao,props.d,props.questionToDisplay, status)}}} className={classes.paper} style={{backgroundColor: color}}>
