...
const multer=require('multer');//za spremanje slika i drugih fileova npm paket-> VAŽNOOO -> KADA ŠALJEMO JSON FORMATIRANI SADRŽAJ UNUTAR REQUEST BODYA  ONDA NJEGA NAŠ BODY PARSER MOŽE PARSIRATI ALI KADA UNUTAR NJEGA
