...
let topic_instance=new topic_class(models.topic,models.asessment_objective,models.course,models.subject,models.result,models.save,models.question,models.tags_of_topic,models.course_topic,result_instance, nodelogger);
...
let class_instance=new clas_class(models.clas,models.user,models.class_student,nodelogger);
