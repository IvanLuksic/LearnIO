...
let login_instance=new login_class(models.user,models.one_time_password,nodelogger);
...
let class_instance=new clas_class(models.clas,models.user,models.class_student,models.subject,models.class_of_teacher, nodelogger);
...
let user_instance=new user_class(models.user,models.clas,models.class_student,models.result,models.save,models.session,models.teacher_subject,models.invite_links,models.class_of_teacher,models.one_time_password, nodelogger);
