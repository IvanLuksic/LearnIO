                    ...
                    <div> 
                        <DialogTitle className={classes.dialogPart1}>
                            <div style={{display:'flex'}}>
                                <Typography variant="h6" component="div" className={classes.questionName}>Notification</Typography>
                        ...
                        <DialogContent className={classes.dialogPart2}>
                                <div>
                                    ...
                                    <Button variant="contained" onClick={()=>props.setOpenPopup(false)} className={classes.pickButton} style={{backgroundColor:"#EB4949", color:"white"}}>OK</Button>
                                    </div>
                                </div>
